...
final class InactivityTimer {
	...
	private static final String TAG = com.example.darren.scanner.InactivityTimer.class.getSimpleName();
	...
	private final class PowerStatusReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if (Intent.ACTION_BATTERY_CHANGED.equals(intent.getAction())) {
				...
				if (onBatteryNow) {
					com.example.darren.scanner.InactivityTimer.this.onActivity();
				}
				else {
					com.example.darren.scanner.InactivityTimer.this.cancel();
				}
			}
		}
	}
