...
import com.example.darren.scanner.decode.DecodeThread;
import com.example.darren.scanner.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	private final com.example.darren.scanner.camera.CameraManager cameraManager;
	...
	public CaptureActivityHandler(com.example.darren.scanner.CaptureActivity activity,
		...
		decodeThread = new DecodeThread(activity, decodeFormats, baseHints,
				characterSet, new com.example.darren.scanner.view.ViewfinderResultPointCallback(
