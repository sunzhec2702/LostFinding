...
import com.example.darren.scanner.camera.FrontLightMode;
...
final class CameraConfigurationManager {
	...
	private void initializeTorch(Camera.Parameters parameters,
		...
		boolean currentSetting = com.example.darren.scanner.camera.FrontLightMode.readPref(prefs) == FrontLightMode.ON;
