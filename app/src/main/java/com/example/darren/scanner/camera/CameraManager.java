...
package com.example.darren.scanner.camera;
...
import com.example.darren.scanner.camera.*;
import com.example.darren.scanner.camera.AutoFocusManager;
import com.example.darren.scanner.camera.OpenCameraInterface;
...
public final class CameraManager {
	...
	private com.example.darren.scanner.camera.AutoFocusManager autoFocusManager;
	...
	public synchronized void openDriver(SurfaceHolder holder)
		...
		if (theCamera == null) {
			// 获取手机背面的摄像头
			theCamera = com.example.darren.scanner.camera.OpenCameraInterface.open();
			if (theCamera == null) {
	...
	public synchronized void startPreview() {
		...
		if (theCamera != null && !previewing) {
			...
			previewing = true;
			autoFocusManager = new com.example.darren.scanner.camera.AutoFocusManager(context, camera);
		}
	}
