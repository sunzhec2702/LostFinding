package com.example.darren.scanner;
...
import com.example.darren.scanner.decode.CaptureActivityHandler;
import com.example.darren.scanner.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements
	...
	private static final String TAG = com.example.darren.scanner.CaptureActivity.class.getSimpleName();
	 ...
	 */
	private com.example.darren.scanner.BeepManager beepManager;
	...
	private com.example.darren.scanner.IntentSource source;
	...
	protected void onResume() {
		...
		source = com.example.darren.scanner.IntentSource.NONE;
		decodeFormats = null;
		characterSet = null;
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		switch (keyCode) {
			case KeyEvent.KEYCODE_BACK:
				if ((source == com.example.darren.scanner.IntentSource.NONE) && lastResult != null) { // 重新进行扫描
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							BitmapDecoder decoder = new BitmapDecoder(
									com.example.darren.scanner.CaptureActivity.this);
